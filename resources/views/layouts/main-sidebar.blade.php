        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('users.index') }}"><span
                        class="side-menu__label">Users</span><span
                        class="badge badge-success side-badge">{{ \App\Models\User::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('roles.index') }}"><span
                        class="side-menu__label">Roles</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Role::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('role-users.index') }}"><span
                        class="side-menu__label">Role-User</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('doctors.index') }}"><span
                        class="side-menu__label">Doctors</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Doctor::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('patients.index') }}"><span
                        class="side-menu__label">Patients</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Patient::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('patient-histories.index') }}"><span
                        class="side-menu__label">Patient-History</span><span
                        class="badge badge-success side-badge">{{ \App\Models\PatientHistory::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('assistants.index') }}"><span
                        class="side-menu__label">Assistants</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Assistant::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('nurses.index') }}"><span
                        class="side-menu__label">Nurses</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Nurse::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('clinics.index') }}"><span
                        class="side-menu__label">Clinics</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Clinic::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('locations.index') }}"><span
                        class="side-menu__label">Locations</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Location::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('medicines.index') }}"><span
                        class="side-menu__label">Medicines</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Medicine::count() }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('prescriptions.index') }}"><span
                        class="side-menu__label">Prescriptions</span><span
                        class="badge badge-success side-badge">{{ \App\Models\Prescription::count() }}</span></a>
            </li>
